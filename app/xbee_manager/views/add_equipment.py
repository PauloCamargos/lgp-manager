...
class Ui_AddEquipment(object):
    def setupUi(self, AddEquipment):
        ...
        self.ledit_equipment = QtWidgets.QLineEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ledit_equipment.sizePolicy().hasHeightForWidth())
        self.ledit_equipment.setSizePolicy(sizePolicy)
        self.ledit_equipment.setBaseSize(QtCore.QSize(0, 0))
        self.ledit_equipment.setObjectName("ledit_equipment")
        self.horizontalLayout_9.addWidget(self.ledit_equipment)
        ...
        self.btn_add_equipment = QtWidgets.QPushButton(AddEquipment)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_add_equipment.sizePolicy().hasHeightForWidth())
        self.btn_add_equipment.setSizePolicy(sizePolicy)
        self.btn_add_equipment.setMinimumSize(QtCore.QSize(400, 0))
        self.btn_add_equipment.setMaximumSize(QtCore.QSize(400, 16777215))
        self.btn_add_equipment.setObjectName("btn_add_equipment")
        self.verticalLayout_2.addWidget(self.btn_add_equipment, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, AddEquipment):
        ...
        self.label_2.setText(_translate("AddEquipment", "Equipamento"))
        ...
        self.btn_add_equipment.setText(_translate("AddEquipment", "Adicionar equipamento"))
